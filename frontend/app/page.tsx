...
import { PlusIcon, WandIcon, ClockIcon, CheckCircleIcon, TrashIcon, EditIcon, PlayIcon } from 'lucide-react';
                ...
                <div className="relative aspect-video bg-gradient-to-br from-slate-800 via-slate-700 to-slate-900 overflow-hidden">
                  ...
                  {project.status === 'completed' && (
                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <div className="w-14 h-14 bg-slate-100/90 rounded-full flex items-center justify-center">
                        <PlayIcon className="w-7 h-7 text-slate-800 ml-1" />
                      </div>
                    </div>
                  )}
                  {project.status !== 'completed' && (
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-slate-800/50 hover:bg-red-500/20 rounded-lg text-slate-400 hover:text-red-400 transition-all border border-slate-600/30 text-sm"
                    >
